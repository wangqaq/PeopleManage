...
<input type="button" id="add" value="搜索" onclick="find();"style="margin-left: 20px" />
<input type="button" id="add" value="添加用户" onclick="add();" style="margin-left: 20px"/>
	<input type="button" id="add" value="所有用户" onclick="refresh()"style="margin-left: 20px">
</div>


<table width="80%" align="center" border="1" bordercolor="#F0F0F0" style="text-align: center;font-family: 微软雅黑;margin-left: 20px">
	...
	<c:forEach items="${list}" var="u"  varStatus="status">
	    <tr height="40px" id="employee${status.index }"><td>${u.userName }</td>
		    ...
		    <input type="button" value="删除" onclick="deleteUser(${u.userId;u.userName});" />
		    </td>
	    </tr>
	</c:forEach>
</table>
